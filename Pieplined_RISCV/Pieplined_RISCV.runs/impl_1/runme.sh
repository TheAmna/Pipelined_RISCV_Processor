...
HD_PWD='C:/Users/drali/Downloads/RISCV_Processor/RISCV_Processor/RISCV_Processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ProcessorFPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ProcessorFPGA.tcl -notrace
