...
HD_PWD='C:/Users/drali/Downloads/RISCV_Processor/RISCV_Processor/RISCV_Processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ProcessorFPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ProcessorFPGA.tcl
